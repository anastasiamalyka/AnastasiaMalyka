...
Змінна об’єкта (властивість) — це дані, які належать конкретному об’єкту.

  5. Як викликати функцію класу?

Функція класу (метод) викликається через об’єкт: об’єкт.метод() (d1.bark())

  6. Як імпортувати клас з зовнішнього файлу?

Щоб імпортувати клас з іншого файлу, використовують import або from ... import (from my_module import Dog)

  7. Яку відповідність з реального світу Ви могли б навести для понять класу та об’єкта?

Клас — це шаблон або модель. Об’єкт — це конкретна річ, створена за цим шаблоном.

Приклад з реального світу: Клас = рецепт піци, об’єкт = готова піца, зроблена за цим рецептом, один клас - можна створити багато різних об’єктів

  ## Висновок:
1. Навчилася оголошувати класи в Python 3.
2. Навчилася створювати об’єкти (“class instances”).
3. Ознайомилася з поняттям змінної (властивості) обʼєкту. Навчилася їх задавати та отримувати їхні значення.
